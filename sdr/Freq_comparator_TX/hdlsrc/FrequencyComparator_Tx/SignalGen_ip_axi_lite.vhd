-- -------------------------------------------------------------
-- 
-- File Name: Freq_comparator_TX\hdlsrc\FrequencyComparator_Tx\SignalGen_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SignalGen_ip_axi_lite
-- Source Path: SignalGen_ip/SignalGen_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SignalGen_ip_axi_lite IS
...
END SignalGen_ip_axi_lite;


ARCHITECTURE rtl OF SignalGen_ip_axi_lite IS

  -- Component Declarations
  COMPONENT SignalGen_ip_addr_decoder
  ...
  COMPONENT SignalGen_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : SignalGen_ip_addr_decoder
    USE ENTITY work.SignalGen_ip_addr_decoder(rtl);

  FOR ALL : SignalGen_ip_axi_lite_module
    USE ENTITY work.SignalGen_ip_axi_lite_module(rtl);
...
BEGIN
  u_SignalGen_ip_addr_decoder_inst : SignalGen_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_real => read_real,  -- sfix16_En14
              read_img => read_img,  -- sfix16_En14
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable  -- ufix1
              );

  u_SignalGen_ip_axi_lite_module_inst : SignalGen_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
