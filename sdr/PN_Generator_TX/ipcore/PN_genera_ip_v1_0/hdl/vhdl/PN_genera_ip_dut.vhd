-- -------------------------------------------------------------
-- 
-- File Name: PN_generator_TX\hdlsrc\PN_generatorV2\PN_genera_ip_dut.vhd
...
ARCHITECTURE rtl OF PN_genera_ip_dut IS
  ...
  COMPONENT PN_genera_ip_src_Transmisor
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : PN_genera_ip_src_Transmisor
    USE ENTITY work.PN_genera_ip_src_Transmisor(rtl);
...
BEGIN
  u_PN_genera_ip_src_Transmisor : PN_genera_ip_src_Transmisor
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
