-- -------------------------------------------------------------
-- 
-- File Name: PN_generator_TX\hdlsrc\PN_generatorV2\PN_genera_ip_src_PN_Sequence_Generator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PN_genera_ip_src_PN_Sequence_Generator1
...
ENTITY PN_genera_ip_src_PN_Sequence_Generator1 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_16_0                        :   IN    std_logic;
        PN_Sequence                       :   OUT   std_logic
        );
END PN_genera_ip_src_PN_Sequence_Generator1;


ARCHITECTURE rtl OF PN_genera_ip_src_PN_Sequence_Generator1 IS
