...
update_ip_catalog
update_ip_catalog -delete_ip {D:/juanj/Documents/MATLAB/repos/TFG/IpCoreRepo/PN_genera_ip_tx_v1_0/component.xml} -repo_path {D:/juanj/Documents/MATLAB/repos/TFG/IpCoreRepo} -quiet
update_ip_catalog -add_ip {D:/juanj/Documents/MATLAB/repos/TFG/IpCoreRepo/PN_genera_ip_tx_v1_0.zip} -repo_path {D:/juanj/Documents/MATLAB/repos/TFG/IpCoreRepo}
update_ip_catalog
set HDLCODERIPVLNV [get_property VLNV [get_ipdefs -filter {NAME==PN_genera_ip_tx && VERSION==1.0}]]
set HDLCODERIPINST PN_genera_ip_tx_0
