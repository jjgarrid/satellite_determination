###########################################################################
## Makefile generated for Simulink model 'PN_generator_Tx'. 
## 
## Makefile     : PN_generator_Tx.mk
## Generated on : Sun May 10 18:40:57 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PN_generator_Tx.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PN_generator_Tx.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/PN_generator_Tx_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/zynq/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/zynq/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/zynq/blocks/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=PN_generator_Tx -DNUMST=6 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/PN_generator_Tx_ert_rtw/PN_generator_Tx.c $(START_DIR)/PN_generator_Tx_ert_rtw/PN_generator_Tx_data.c $(START_DIR)/PN_generator_Tx_ert_rtw/rtGetInf.c $(START_DIR)/PN_generator_Tx_ert_rtw/rtGetNaN.c $(START_DIR)/PN_generator_Tx_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c C:/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/target/supportpackages/zynq/src/axi4Lite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/PN_generator_Tx_ert_rtw/ert_main.c
...
OBJS = PN_generator_Tx.c.o PN_generator_Tx_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o axi4Lite.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/PN_generator_Tx_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/PN_generator_Tx_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PN_generator_Tx.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/PN_generator_Tx.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PN_generator_Tx_data.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/PN_generator_Tx_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/PN_generator_Tx_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
