-- -------------------------------------------------------------
-- 
-- File Name: PN_generator_RX\hdlsrc\PN_generatorV2\PN_genera_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PN_genera_ip_axi_lite
-- Source Path: PN_genera_ip/PN_genera_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PN_genera_ip_axi_lite IS
...
END PN_genera_ip_axi_lite;


ARCHITECTURE rtl OF PN_genera_ip_axi_lite IS

  -- Component Declarations
  COMPONENT PN_genera_ip_addr_decoder
  ...
  COMPONENT PN_genera_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : PN_genera_ip_addr_decoder
    USE ENTITY work.PN_genera_ip_addr_decoder(rtl);

  FOR ALL : PN_genera_ip_axi_lite_module
    USE ENTITY work.PN_genera_ip_axi_lite_module(rtl);
...
BEGIN
  u_PN_genera_ip_addr_decoder_inst : PN_genera_ip_addr_decoder
  ...
  u_PN_genera_ip_axi_lite_module_inst : PN_genera_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
