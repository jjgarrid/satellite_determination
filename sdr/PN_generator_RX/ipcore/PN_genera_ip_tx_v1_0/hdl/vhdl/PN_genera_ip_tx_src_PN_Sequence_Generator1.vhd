-- -------------------------------------------------------------
-- 
-- File Name: PN_generator_RX\hdlsrc\PN_generatorV2\PN_genera_ip_tx_src_PN_Sequence_Generator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: PN_genera_ip_tx_src_PN_Sequence_Generator1
-- Source Path: PN_generatorV2/Transmisor/Gold Sequence Generator/PN Sequence Generator1
-- Hierarchy Level: 2
-- 
...
ENTITY PN_genera_ip_tx_src_PN_Sequence_Generator1 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_16_0                        :   IN    std_logic;
        PN_Sequence                       :   OUT   std_logic
        );
END PN_genera_ip_tx_src_PN_Sequence_Generator1;


ARCHITECTURE rtl OF PN_genera_ip_tx_src_PN_Sequence_Generator1 IS
...
BEGIN
  ...
  VectorTDL_Initial_Val_out(1) <= '1';
  VectorTDL_Initial_Val_out(2) <= '0';
  VectorTDL_Initial_Val_out(3) <= '1';
